...
void MainWindow::addPoints(double x, double y, double z)
{
      ...
      QPixmap mypix ("C:/Users/melik/Desktop/Proje/Qt/DesktopApplication/desktopApplication/position.png");
      ...
      QPixmap mypix2 ("C:/Users/melik/Desktop/Proje/Qt/DesktopApplication/desktopApplication/height.png");
      ...
      QPixmap mypix3 ("C:/Users/melik/Desktop/Proje/Qt/DesktopApplication/desktopApplication/radius.png");
...
void MainWindow::processPendingDatagrams()
{
 ...
 /*   QDateTime dateTime;
    ...
    QString degreeValueString;
    QString hardwareDegreeValueString;
    int flagVal;
    int flagRemote;
    ...
    in>>degreeValueString>>hardwareDegreeValueString>>flagVal>>flagRemote;*/
...
void MainWindow::sendDatagram()
{
    if(isServerOpen){
         ...
         //  out.setVersion(QDataStream::Qt_4_3);
           ...
           QByteArray datagram(message.c_str(), message.length());
